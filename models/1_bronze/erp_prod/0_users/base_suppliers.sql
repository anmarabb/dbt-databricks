...
from {{ source('erp', 'manageable_accounts') }} 
...
from {{ source('erp', 'suppliers') }} as s
...
left join {{ source('erp', 'account_managers') }} as account_m on mas.account_manager_id = account_m.id
